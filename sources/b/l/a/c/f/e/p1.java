                ...
                if (a.p1(b3)) {
                    ...
                    if (!(b3 < -32)) {
                        if (b3 < -16) {
                            if (i7 < i5 - 1) {
                                int i9 = i7 + 1;
                                a.j2(b3, bArr[i7], bArr[i9], cArr, i4);
                                r13 = i9 + 1;
                                i4++;
                            } else {
                                throw l.g();
                            ...
                            int i10 = i7 + 1;
                            int i11 = i10 + 1;
                            a.p2(b3, bArr[i7], bArr[i10], bArr[i11], cArr, i4);
                            i4 += 2;
                            r13 = i11 + 1;
                        } else {
                            throw l.g();
