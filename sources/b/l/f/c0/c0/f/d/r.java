...
public final class r {
    ...
    public static String a(String str) {
        ...
        if (str.length() >= 2) {
            ...
            for (Object[] objArr : f5628b) {
                if (objArr[0].equals(substring)) {
                    return objArr[1] == obj ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) objArr[1]).intValue(), str);
                }
            }
            if (str.length() >= 3) {
                ...
                for (Object[] objArr2 : c) {
                    if (objArr2[0].equals(substring2)) {
                        return objArr2[1] == obj ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) objArr2[1]).intValue(), str);
                    }
                }
                for (Object[] objArr3 : d) {
                    if (objArr3[0].equals(substring2)) {
                        return objArr3[1] == obj ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) objArr3[1]).intValue(), str);
                    }
                }
                if (str.length() >= 4) {
                    String substring3 = str.substring(0, 4);
                    for (Object[] objArr4 : f5629e) {
                        if (objArr4[0].equals(substring3)) {
                            return objArr4[1] == obj ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) objArr4[1]).intValue(), str);
                        }
                    }
                    throw m.f5759j;
                }
    ...
    public static String b(int i2, int i3, String str) {
        if (str.length() >= i2) {
            ...
            if (str.length() >= i4) {
                ...
                return a2 == null ? str2 : a.m(str2, a2);
            }
            throw m.f5759j;
        }
        throw m.f5759j;
