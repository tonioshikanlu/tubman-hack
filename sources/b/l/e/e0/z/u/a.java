...
public class a {
    ...
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) {
        ...
        L_0x0213:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: b.l.e.e0.z.u.a.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
    ...
    public static int c(String str, int i2, int i3) {
        ...
        if (i2 < i3) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder y = b.e.a.a.a.y("Invalid number: ");
        ...
        while (i5 < i3) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder y2 = b.e.a.a.a.y("Invalid number: ");
