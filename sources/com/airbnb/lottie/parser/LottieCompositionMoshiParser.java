...
public class LottieCompositionMoshiParser {
    public static JsonReader.Options ASSETS_NAMES = JsonReader.Options.of(AnalyticsContext.Device.DEVICE_ID_KEY, "layers", "w", h.f414g, "p", "u");
    private static final JsonReader.Options FONT_NAMES = JsonReader.Options.of("list");
    private static final JsonReader.Options MARKER_NAMES = JsonReader.Options.of(cm.f2896n, "tm", "dr");
    private static final JsonReader.Options NAMES = JsonReader.Options.of("w", h.f414g, "ip", "op", "fr", "v", "layers", "assets", "fonts", "chars", "markers");
    ...
    public static LottieComposition parse(JsonReader jsonReader) {
        ...
        lottieComposition.init(new Rect(0, 0, (int) (((float) i2) * dpScale), (int) (((float) i3) * dpScale)), f, f2, f3, arrayList2, longSparseArray, hashMap2, hashMap3, sparseArrayCompat, hashMap4, arrayList3);
