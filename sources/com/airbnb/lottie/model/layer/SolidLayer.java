...
public class SolidLayer extends BaseLayer {
    ...
    public void drawLayer(Canvas canvas, Matrix matrix, int i2) {
        ...
        if (alpha != 0) {
            int intValue = (int) ((((((float) alpha) / 255.0f) * ((float) (this.transform.getOpacity() == null ? 100 : this.transform.getOpacity().getValue().intValue()))) / 100.0f) * (((float) i2) / 255.0f) * 255.0f);
