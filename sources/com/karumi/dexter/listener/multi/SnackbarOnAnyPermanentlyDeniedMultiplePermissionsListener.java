...
public class SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    private SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener(View view2, String str, String str2, View.OnClickListener onClickListener, Snackbar.Callback callback, int i2) {
        this.view = view2;
        this.text = str;
