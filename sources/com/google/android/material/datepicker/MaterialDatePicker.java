...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        return a.b(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_vertical_padding) * (i2 - 1)) + (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) * i2), resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_bottom_padding));
    }
