...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v, int i2, int i3, float f) {
        V v2 = v;
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f), 0, 0, i2, i3);
