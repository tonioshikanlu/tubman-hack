...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float f11 = fitModeResult2.currentEndWidth;
            rectF2.set(f8 - (f11 / 2.0f), f9, (f11 / 2.0f) + f8, fitModeResult2.currentEndHeight + f9);
            ...
            float f13 = (float) ((int) (calculateElevationDyMultiplier * f12));
            this.currentElevationDy = f13;
            this.shadowPaint.setShadowLayer(f12, (float) ((int) (calculateElevationDxMultiplier * f12)), f13, SHADOW_COLOR);
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        StringBuilder y = a.y("Invalid transition direction: ");
        y.append(this.transitionDirection);
