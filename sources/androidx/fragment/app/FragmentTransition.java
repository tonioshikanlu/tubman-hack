...
public class FragmentTransition {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:88:0x00e6 A[ADDED_TO_REGION] */
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManagerImpl, int i2, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        View view2 = view;
        ArrayMap<String, String> arrayMap2 = arrayMap;
        ViewGroup viewGroup = fragmentManagerImpl2.mContainer.onHasView() ? (ViewGroup) fragmentManagerImpl2.mContainer.onFindViewById(i2) : null;
