...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder y = a.y("FragmentTabHost.SavedState{");
            y.append(Integer.toHexString(System.identityHashCode(this)));
            y.append(" curTab=");
            return a.q(y, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            if (frameLayout == null) {
                StringBuilder y = a.y("No tab content FrameLayout found for id ");
                y.append(this.mContainerId);
