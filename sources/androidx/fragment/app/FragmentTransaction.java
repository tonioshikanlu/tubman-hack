        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(a.n("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i2, Fragment fragment, @Nullable String str, int i3) {
        ...
        if (str != null) {
            ...
            if (str2 == null || str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(a.r(sb, fragment.mTag, " now ", str));
            }
        }
        if (i2 != 0) {
            if (i2 != -1) {
