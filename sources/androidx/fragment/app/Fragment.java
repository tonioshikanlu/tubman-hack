...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(a.n("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (IllegalAccessException e3) {
            throw new InstantiationException(a.n("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e3);
        } catch (NoSuchMethodException e4) {
            throw new InstantiationException(a.n("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e4);
        } catch (InvocationTargetException e5) {
            throw new InstantiationException(a.n("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e5);
        }
    }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(a.m(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onAttach()"));
        }
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onDetach()"));
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(a.l("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(a.l("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(a.l("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.l("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i2) {
        ...
        throw new IllegalArgumentException(a.l("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
