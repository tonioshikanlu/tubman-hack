...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(a.m(str, "  "), fileDescriptor, printWriter, strArr);
        ...
        public String toString() {
            StringBuilder x = a.x(64, "LoaderInfo{");
            x.append(Integer.toHexString(System.identityHashCode(this)));
            x.append(" #");
            x.append(this.mId);
            x.append(" : ");
            DebugUtils.buildShortClassTag(this.mLoader, x);
            x.append("}}");
            return x.toString();
        }
    }
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d) {
            if (LoaderManagerImpl.DEBUG) {
                StringBuilder y = a.y("  onLoadFinished in ");
                y.append(this.mLoader);
                y.append(": ");
                y.append(this.mLoader.dataToString(d));
                Log.v(LoaderManagerImpl.TAG, y.toString());
            }
    ...
    public String toString() {
        StringBuilder x = a.x(128, "LoaderManager{");
        x.append(Integer.toHexString(System.identityHashCode(this)));
        x.append(" in ");
        DebugUtils.buildShortClassTag(this.mLifecycleOwner, x);
        x.append("}}");
        return x.toString();
    }
}
