...
public class CustomTabsClient {
    ...
    public CustomTabsSession newSession(final CustomTabsCallback customTabsCallback) {
        AnonymousClass2 r0 = new a.C0147a() {
            ...
            public void onRelationshipValidationResult(int i2, Uri uri, boolean z, @Nullable Bundle bundle) {
                if (customTabsCallback != null) {
                    final int i3 = i2;
                    final Uri uri2 = uri;
                    final boolean z2 = z;
                    ...
                    this.mHandler.post(new Runnable() {
                        public void run() {
                            customTabsCallback.onRelationshipValidationResult(i3, uri2, z2, bundle2);
                        }
                    });
                }
            }
