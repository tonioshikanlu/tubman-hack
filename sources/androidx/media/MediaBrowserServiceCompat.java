...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i2, Bundle bundle) {
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(str, -1, i2, bundle, (ServiceCallbacks) null);
        ...
        public void setSessionToken(final MediaSessionCompat.Token token) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.f32h);
                }
            });
        }
    }
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            StringBuilder y = a.y("Connection for ");
                            y.append(next.pkg);
                            y.append(" is no longer valid.");
                            Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                            it.remove();
                        }
                    }
                }
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder y = a.y("detach() called when detach() had already been called for: ");
                y.append(this.mDebug);
                throw new IllegalStateException(y.toString());
            } else if (this.mSendResultCalled) {
                StringBuilder y2 = a.y("detach() called when sendResult() had already been called for: ");
                y2.append(this.mDebug);
                throw new IllegalStateException(y2.toString());
            } else if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder y3 = a.y("detach() called when sendError() had already been called for: ");
                y3.append(this.mDebug);
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder y = a.y("It is not supported to send an error for ");
            y.append(this.mDebug);
            throw new UnsupportedOperationException(y.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder y = a.y("It is not supported to send an interim update for ");
            y.append(this.mDebug);
            throw new UnsupportedOperationException(y.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder y = a.y("sendError() called when either sendResult() or sendError() had already been called for: ");
                y.append(this.mDebug);
                throw new IllegalStateException(y.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder y = a.y("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                y.append(this.mDebug);
                throw new IllegalStateException(y.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder y = a.y("sendResult() called when either sendResult() or sendError() had already been called for: ");
                y.append(this.mDebug);
                throw new IllegalStateException(y.toString());
            }
    ...
    public class ServiceBinderImpl {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        StringBuilder y = a.y("addSubscription for callback that isn't registered id=");
                        y.append(str2);
                        Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                        return;
                    }
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i3)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        BrowserRoot onGetRoot = mediaBrowserServiceCompat.onGetRoot(str2, i5, bundle2);
                        connectionRecord.root = onGetRoot;
                        MediaBrowserServiceCompat mediaBrowserServiceCompat2 = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat2.mCurConnection = null;
                        if (onGetRoot == null) {
                            StringBuilder y = a.y("No root for client ");
                            y.append(str2);
                            y.append(" from service ");
                            y.append(getClass().getName());
                            Log.i(MediaBrowserServiceCompat.TAG, y.toString());
                            try {
                                serviceCallbacks2.onConnectFailed();
                            } catch (RemoteException unused) {
                                StringBuilder y2 = a.y("Calling onConnectFailed() failed. Ignoring. pkg=");
                                y2.append(str2);
                                Log.w(MediaBrowserServiceCompat.TAG, y2.toString());
                            }
                        } else {
                            try {
                                ...
                                StringBuilder y3 = a.y("Calling onConnect() failed. Dropping client. pkg=");
                                y3.append(str2);
                                Log.w(MediaBrowserServiceCompat.TAG, y3.toString());
                                MediaBrowserServiceCompat.this.mConnections.remove(asBinder);
                            }
                        }
                    }
        ...
        public void getMediaItem(final String str, final h.a.b.c.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder y = a.y("getMediaItem for callback that isn't registered id=");
                            y.append(str);
                            Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                            return;
                        }
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder y = a.y("removeSubscription for callback that isn't registered id=");
                        y.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                        StringBuilder y2 = a.y("removeSubscription called for ");
                        y2.append(str);
        ...
        public void search(String str, Bundle bundle, h.a.b.c.b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
                final String str2 = str;
                final Bundle bundle2 = bundle;
                final h.a.b.c.b bVar2 = bVar;
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder y = a.y("search for callback that isn't registered query=");
                            y.append(str2);
                            Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                            return;
                        }
        ...
        public void sendCustomAction(String str, Bundle bundle, h.a.b.c.b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
                final String str2 = str;
                final Bundle bundle2 = bundle;
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder y = a.y("sendCustomAction for callback that isn't registered action=");
                            y.append(str2);
                            y.append(", extras=");
                            y.append(bundle2);
                            Log.w(MediaBrowserServiceCompat.TAG, y.toString());
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (h.a.b.c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (h.a.b.c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (h.a.b.c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    public void onCreate() {
        ...
        this.mImpl = i2 >= 28 ? new MediaBrowserServiceImplApi28() : i2 >= 26 ? new MediaBrowserServiceImplApi26() : new MediaBrowserServiceImplApi23();
        this.mImpl.onCreate();
    }
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final h.a.b.c.b bVar) {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
            ...
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord2.callbacks.asBinder()) == connectionRecord2) {
                    ...
                    try {
                        ...
                        StringBuilder y = a.y("Calling onLoadChildren() failed for id=");
                        y.append(str2);
                        y.append(" package=");
                        y.append(connectionRecord2.pkg);
                        Log.w(MediaBrowserServiceCompat.TAG, y.toString());
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    StringBuilder y2 = a.y("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                    y2.append(connectionRecord2.pkg);
                    y2.append(" id=");
                    y2.append(str2);
                    Log.d(MediaBrowserServiceCompat.TAG, y2.toString());
                }
            }
        };
        this.mCurConnection = connectionRecord;
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(a.r(a.y("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }

    public void performLoadItem(String str, ConnectionRecord connectionRecord, final h.a.b.c.b bVar) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(a.m("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }

    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final h.a.b.c.b bVar) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(a.m("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
