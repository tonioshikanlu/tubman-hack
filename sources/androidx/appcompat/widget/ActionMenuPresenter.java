    ...
    public boolean flagActionItems() {
        ...
        while (i13 < i2) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i4 -= ActionMenuView.measureChildForCells(itemView, i3, i4, makeMeasureSpec, z2 ? 1 : 0);
                } else {
                ...
                boolean z5 = (i11 > 0 || z4) && i7 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i4 > 0);
                boolean z6 = z5;
                i5 = i2;
                if (z5) {
                    ...
                    z5 = z7 & (!actionMenuPresenter.mStrictWidthLimit ? i7 + i14 > 0 : i7 >= 0);
                }
                if (z5 && groupId2 != 0) {
