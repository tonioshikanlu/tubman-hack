...
public class SwitchCompat extends CompoundButton {
    ...
    private boolean hitThumb(float f, float f2) {
        ...
        Rect rect = this.mTempRect;
        return f > ((float) i5) && f < ((float) ((((this.mThumbWidth + i5) + rect.left) + rect.right) + i3)) && f2 > ((float) i4) && f2 < ((float) (this.mSwitchBottom + i3));
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            i7 = ((this.mSwitchWidth + i8) - i6) - i11;
        } else {
            i7 = (getWidth() - getPaddingRight()) - i11;
            i8 = (i7 - this.mSwitchWidth) + i6 + i11;
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.mShowText) {
            i6 = (this.mThumbTextPadding * 2) + Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth());
        } else {
            i6 = 0;
        }
