...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        public void onMeasure(int i2, int i3) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > (i4 = ScrollingTabContainerView.this.mMaxTabWidth)) {
    ...
    public void animateToVisibility(int i2) {
        ...
        viewPropertyAnimator.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimator, i2));
