...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int r5) {
        ...
        L_0x0050:
            ...
            java.lang.String r5 = b.e.a.a.a.g(r1, r5)
            r0.<init>(r5)
            throw r0
        L_0x005c:
            r4.ensureSpinner()
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i2, long j2) {
        return ViewCompat.animate(this.mToolbar).alpha(i2 == 0 ? 1.0f : 0.0f).setDuration(j2).setListener(new ViewPropertyAnimatorListenerAdapter() {
