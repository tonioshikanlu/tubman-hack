    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            if (id == -1) {
                ...
                StringBuilder y = a.y(" with id '");
                y.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                y.append("'");
                str = y.toString();
            }
            StringBuilder y2 = a.y("Could not find method ");
            y2.append(this.mMethodName);
            y2.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            y2.append(this.mHostView.getClass());
            y2.append(str);
