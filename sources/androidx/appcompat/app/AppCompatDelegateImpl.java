...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i2) {
            return (!AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() || i2 != 0) ? super.onWindowStartingActionMode(callback, i2) : startAsSupportActionMode(callback);
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(i2)) {
            ...
            StringBuilder y = a.y("AppCompat does not support the current theme features: { windowActionBar: ");
            y.append(this.mHasActionBar);
            y.append(", windowActionBarOverlay: ");
            y.append(this.mOverlayActionBar);
            y.append(", android:windowIsFloating: ");
            y.append(this.mIsFloating);
            y.append(", windowActionModeOverlay: ");
            y.append(this.mOverlayActionMode);
            y.append(", windowNoTitle: ");
            throw new IllegalArgumentException(a.s(y, this.mWindowNoTitle, " }"));
        }
        obtainStyledAttributes.recycle();
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (i4 <= 0 || this.mStatusGuard != null) {
                    ...
                    if (!(view == null || ((marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams()).height == (i2 = marginLayoutParams2.topMargin) && marginLayoutParams.leftMargin == systemWindowInsetLeft && marginLayoutParams.rightMargin == systemWindowInsetRight))) {
