...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i2, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder y = a.y("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    y.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(a.c(this.mRecyclerView, y));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(a.c(this.mRecyclerView, a.y("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void measureChild(@NonNull View view, int i2, int i3) {
            ...
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingRight() + getPaddingLeft() + i4, layoutParams.width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingBottom() + getPaddingTop() + i5, layoutParams.height, canScrollVertically());
        ...
        public void measureChildWithMargins(@NonNull View view, int i2, int i3) {
            ...
            int i4 = itemDecorInsetsForChild.left + itemDecorInsetsForChild.right + i2;
            int i5 = itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom + i3;
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingRight() + getPaddingLeft() + layoutParams.leftMargin + layoutParams.rightMargin + i4, layoutParams.width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingBottom() + getPaddingTop() + layoutParams.topMargin + layoutParams.bottomMargin + i5, layoutParams.height, canScrollVertically());
            if (shouldMeasureChild(view, childMeasureSpec, childMeasureSpec2, layoutParams)) {
                view.measure(childMeasureSpec, childMeasureSpec2);
            }
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@androidx.annotation.NonNull android.view.View r7, int r8) {
            ...
            L_0x005e:
                ...
                java.lang.StringBuilder r8 = b.e.a.a.a.A(r0, r8, r1, r2, r3)
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r0 = r0.mState
                int r0 = r0.getItemCount()
                r8.append(r0)
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                java.lang.String r8 = b.e.a.a.a.c(r0, r8)
                r7.<init>(r8)
                throw r7
            L_0x007f:
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            ...
            StringBuilder z = a.z("invalid position ", i2, ". State item count is ");
            z.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(a.c(RecyclerView.this, z));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder y = a.y("Scrapped or attached views may not be recycled. isScrap:");
                y.append(viewHolder.isScrap());
                y.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z3 = true;
                }
                y.append(z3);
                throw new IllegalArgumentException(a.c(RecyclerView.this, y));
                ...
                throw new IllegalArgumentException(a.c(RecyclerView.this, a.y("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(a.c(RecyclerView.this, a.y("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b1:
                ...
                java.lang.String r1 = b.e.a.a.a.c(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c3:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
            ...
            L_0x0133:
                ...
                java.lang.StringBuilder r1 = b.e.a.a.a.A(r1, r3, r2, r5, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
            ...
            L_0x01fb:
                ...
                java.lang.StringBuilder r1 = b.e.a.a.a.A(r1, r3, r2, r3, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r2 = r2.mState
                int r2 = r2.getItemCount()
                r1.append(r2)
    ...
    public static abstract class SmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int i2) {
            ...
            StringBuilder y = a.y("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
            y.append(ScrollVectorProvider.class.getCanonicalName());
            Log.w(RecyclerView.TAG, y.toString());
            return null;
        }
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (this.mStarted) {
                StringBuilder y = a.y("An instance of ");
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i2) {
            if ((this.mLayoutStep & i2) == 0) {
                StringBuilder y = a.y("Layout state should be one of ");
                y.append(Integer.toBinaryString(i2));
                y.append(" but it is ");
                y.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder y = a.y("State{mTargetPosition=");
            y.append(this.mTargetPosition);
            y.append(", mData=");
            y.append(this.mData);
            y.append(", mItemCount=");
            y.append(this.mItemCount);
            y.append(", mIsMeasuring=");
            y.append(this.mIsMeasuring);
            y.append(", mPreviousLayoutItemCount=");
            y.append(this.mPreviousLayoutItemCount);
            y.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            y.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            y.append(", mStructureChanged=");
            y.append(this.mStructureChanged);
            y.append(", mInPreLayout=");
            y.append(this.mInPreLayout);
            y.append(", mRunSimpleAnimations=");
            y.append(this.mRunSimpleAnimations);
            y.append(", mRunPredictiveAnimations=");
            y.append(this.mRunPredictiveAnimations);
            y.append('}');
            return y.toString();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                StringBuilder y = a.y(" not recyclable(");
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(a.c(this, a.y("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(a.c(this, a.y(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(a.c(this, a.y("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(a.c(this, a.y(""))));
        }
    }
    ...
    public void ensureBottomGlow() {
        ...
        if (this.mBottomGlow == null) {
            ...
            createEdgeEffect.setSize(i3, i2);
        }
    }
    ...
    public String exceptionLabel() {
        ...
        y.append(", adapter:");
        y.append(this.mAdapter);
        y.append(", layout:");
        y.append(this.mLayout);
        y.append(", context:");
        y.append(getContext());
        return y.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(a.c(this, a.y("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(a.c(this, a.y("Trying to set fast scroller without both required drawables.")));
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                StringBuilder y2 = a.y("Error processing scroll; pointer index for id ");
                y2.append(this.mScrollPointerId);
