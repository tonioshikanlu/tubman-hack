...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i2, Transition transition) {
                ...
                if (view == null) {
                    StringBuilder y = a.y("OnClick could not find id ");
                    y.append(this.mTargetId);
                    Log.e(MotionScene.TAG, y.toString());
                    return;
                }
                ...
                int i4 = this.mMode;
                boolean z = false;
                boolean z2 = ((i4 & 1) != 0 && i2 == access$100) | ((i4 & 1) != 0 && i2 == access$100) | ((i4 & 256) != 0 && i2 == access$100) | ((i4 & 16) != 0 && i2 == access$000);
                if ((i4 & 4096) != 0 && i2 == access$000) {
                    z = true;
                }
                if (z2 || z) {
                    view.setOnClickListener(this);
            ...
            public boolean isTransitionViable(Transition transition, MotionLayout motionLayout) {
                ...
                return access$100 == -1 ? i2 != access$000 : i2 == access$100 || i2 == access$000;
            }
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                if (i2 != -1) {
                    ...
                    if (findViewById == null) {
                        StringBuilder y = a.y(" (*)  could not find id ");
                        y.append(this.mTargetId);
                        Log.e(MotionScene.TAG, y.toString());
                        return;
                    }
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                access$1100.append(i2, constraintSet);
            }
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return a.m(resourceEntryName, " -> null");
            }
            StringBuilder B = a.B(resourceEntryName, " -> ");
            B.append(context.getResources().getResourceEntryName(this.mConstraintSetEnd));
            return B.toString();
        }
    ...
    private int getId(Context context, String str) {
        int i2;
        if (str.contains("/")) {
            i2 = context.getResources().getIdentifier(str.substring(str.indexOf(47) + 1), AnalyticsContext.Device.DEVICE_ID_KEY, context.getPackageName());
    ...
    private int getIndex(Transition transition) {
        ...
        if (access$300 != -1) {
            for (int i2 = 0; i2 < this.mTransitionList.size(); i2++) {
                if (this.mTransitionList.get(i2).mId == access$300) {
                    return i2;
                }
            }
            return -1;
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            } else if (attributeName.equals(AnalyticsContext.Device.DEVICE_ID_KEY)) {
    ...
    private void readConstraintChain(int i2) {
        ...
        if (i3 > 0) {
            ...
            if (constraintSet2 == null) {
                StringBuilder y = a.y("ERROR! invalid deriveConstraintsFrom: @id/");
                y.append(Debug.getName(this.mMotionLayout.getContext(), i3));
        ...
        for (Transition next : transitionsWithState) {
            if (!next.mDisable && next.mTouchResponse != null) {
                ...
                if ((touchRegion2 == null || motionEvent == null || touchRegion2.contains(motionEvent.getX(), motionEvent.getY())) && ((touchRegion = next.mTouchResponse.getTouchRegion(this.mMotionLayout, rectF)) == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY()))) {
                    float dot = next.mTouchResponse.dot(f, f2) * (next.mConstraintSetEnd == i2 ? -1.0f : 1.1f);
                    if (dot > f3) {
                        transition = next;
                        f3 = dot;
                    }
    ...
    public ConstraintSet getConstraintSet(int i2, int i3, int i4) {
        ...
        if (this.DEBUG_DESKTOP) {
            ...
            y.append(this.mConstraintSetMap.size());
        ...
        if (this.mConstraintSetMap.get(i2) == null) {
            StringBuilder y2 = a.y("Warning could not find ConstraintSet id/");
            y2.append(Debug.getName(this.mMotionLayout.getContext(), i2));
            y2.append(" In MotionScene");
            Log.e(TAG, y2.toString());
            SparseArray sparseArray = this.mConstraintSetMap;
            obj = sparseArray.get(sparseArray.keyAt(0));
        } else {
            obj = this.mConstraintSetMap.get(i2);
        }
            ...
            while (true) {
                if (it2.hasNext()) {
                    ...
                    if (i3 == next.intValue()) {
                        ...
                        while (it3.hasNext()) {
                            Key next2 = it3.next();
                            if (next2.mFramePosition == i4 && next2.mType == i2) {
                                return next2;
                            }
                        }
                        continue;
    ...
    public void readFallback(MotionLayout motionLayout) {
        int i2 = 0;
        while (i2 < this.mConstraintSetMap.size()) {
            int keyAt = this.mConstraintSetMap.keyAt(i2);
        ...
        for (int i3 = 0; i3 < this.mConstraintSetMap.size(); i3++) {
            this.mConstraintSetMap.valueAt(i3).readFallback((ConstraintLayout) motionLayout);
        }
    }
