...
public class Metrics {
    ...
    public String toString() {
        ...
        y.append("\nmeasuresWrap: ");
        y.append(this.measuresWrap);
        y.append("\nmeasuresWrapInfeasible: ");
        y.append(this.measuresWrapInfeasible);
        y.append("\ndetermineGroups: ");
        y.append(this.determineGroups);
        y.append("\ninfeasibleDetermineGroups: ");
        y.append(this.infeasibleDetermineGroups);
        y.append("\ngraphOptimizer: ");
        y.append(this.graphOptimizer);
        y.append("\nwidgets: ");
        y.append(this.widgets);
        y.append("\ngraphSolved: ");
        y.append(this.graphSolved);
        y.append("\nlinearSolved: ");
        y.append(this.linearSolved);
        y.append("\n");
        return y.toString();
    }
}
