    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (!this.mResizeClip) {
                ...
                if (i2 == 2) {
                    if (i12 == i14 && i13 == i15) {
                        path = getPathMotion().getPath((float) i4, (float) i6, (float) i5, (float) i7);
                        ...
                        ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath((float) i8, (float) i10, (float) i9, (float) i11));
                    ...
                    path = getPathMotion().getPath((float) i8, (float) i10, (float) i9, (float) i11);
                ...
                ObjectAnimator ofPointF3 = (i4 == i5 && i6 == i7) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i4, (float) i6, (float) i5, (float) i7));
                if (rect7 == null) {
                    i3 = 0;
                    ...
                    ofObject.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animator) {
                            if (!this.mIsCanceled) {
                                ...
                                ViewUtils.setLeftTopRightBottom(view4, i16, i17, i18, i19);
                            }
                        }
                    });
