...
public class WindowInsetsCompat {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.mImpl = Build.VERSION.SDK_INT >= 29 ? new BuilderImpl29() : new BuilderImpl20();
        }

        public Builder(@NonNull WindowInsetsCompat windowInsetsCompat) {
            this.mImpl = Build.VERSION.SDK_INT >= 29 ? new BuilderImpl29(windowInsetsCompat) : new BuilderImpl20(windowInsetsCompat);
        }
    ...
    private WindowInsetsCompat(@NonNull WindowInsets windowInsets) {
        ...
        this.mImpl = i2 >= 29 ? new Impl29(this, windowInsets) : i2 >= 28 ? new Impl28(this, windowInsets) : new Impl21(this, windowInsets);
    }
    ...
    public WindowInsetsCompat(@Nullable WindowInsetsCompat windowInsetsCompat) {
        ...
        if (windowInsetsCompat != null) {
            ...
            } else if (impl2 instanceof Impl21) {
                impl20 = new Impl21(this, (Impl21) impl2);
            } else if (impl2 instanceof Impl20) {
    ...
    public boolean hasInsets() {
        if (!hasSystemWindowInsets() && !hasStableInsets() && getDisplayCutout() == null) {
            ...
            return !systemGestureInsets.equals(insets) || !getMandatorySystemGestureInsets().equals(insets) || !getTappableElementInsets().equals(insets);
        }
    }
