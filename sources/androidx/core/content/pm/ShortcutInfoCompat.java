...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i2 < this.mPersons.length) {
                StringBuilder y = a.y(EXTRA_PERSON_);
                int i3 = i2 + 1;
                y.append(i3);
                persistableBundle.putPersistableBundle(y.toString(), this.mPersons[i2].toPersistableBundle());
                i2 = i3;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i3 < i2) {
            ...
            int i4 = i3 + 1;
            y.append(i4);
            personArr[i3] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(y.toString()));
            i3 = i4;
        }
        return personArr;
    }
