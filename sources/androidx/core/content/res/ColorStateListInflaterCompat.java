...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i2, @FloatRange(from = 0.0d, to = 1.0d) float f) {
        return (i2 & ViewCompat.MEASURED_SIZE_MASK) | (Math.round(((float) Color.alpha(i2)) * f) << 24);
    }
