...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public String toString() {
            ...
            StringBuilder y = a.y("textSize=");
            y.append(this.mPaint.getTextSize());
            sb.append(y.toString());
            sb.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb.append(", textSkewX=" + this.mPaint.getTextSkewX());
            int i2 = Build.VERSION.SDK_INT;
            StringBuilder y2 = a.y(", letterSpacing=");
            y2.append(this.mPaint.getLetterSpacing());
            sb.append(y2.toString());
            sb.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            sb.append(", textLocale=" + this.mPaint.getTextLocales());
            sb.append(", typeface=" + this.mPaint.getTypeface());
            if (i2 >= 26) {
                StringBuilder y3 = a.y(", variationSettings=");
                y3.append(this.mPaint.getFontVariationSettings());
                sb.append(y3.toString());
            }
            StringBuilder y4 = a.y(", textDir=");
            y4.append(this.mTextDir);
    ...
    public <T> T[] getSpans(int i2, int i3, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? this.mWrapped.getSpans(i2, i3, cls) : this.mText.getSpans(i2, i3, cls);
    }
