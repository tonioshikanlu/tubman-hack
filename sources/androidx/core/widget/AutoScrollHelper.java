...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long j2) {
            ...
            return (AutoScrollHelper.constrain(((float) (j2 - j4)) / ((float) this.mEffectiveRampDown), 0.0f, 1.0f) * f) + (1.0f - f);
        }
    ...
    private float computeTargetVelocity(int i2, float f, float f2, float f3) {
        ...
        float f7 = f4 * f3;
        return i3 > 0 ? constrain(edgeValue * f7, f5, f6) : -constrain((-edgeValue) * f7, f5, f6);
    }
    ...
    private float constrainEdgeValue(float f, float f2) {
        ...
        if (i2 == 0 || i2 == 1) {
            if (f < f2) {
                return f >= 0.0f ? 1.0f - (f / f2) : (!this.mAnimating || i2 != 1) ? 0.0f : 1.0f;
            }
        } else if (i2 == 2 && f < 0.0f) {
            return f / (-f2);
        }
