...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j2, int i2) {
        ...
        if (i8 != 0) {
            ...
            i7 = 0;
            for (int accumField5 = accumField(i11, 2, true, accumField4 > 0 ? 3 : 0) + 1 + accumField4; accumField5 < i8; accumField5++) {
                cArr[i7] = ' ';
                i7++;
            }
        } else {
        ...
        boolean z = i8 != 0;
        int i14 = i13;
        int printField = printField(cArr, i3, 'd', i13, false, 0);
        int printField2 = printField(cArr, i4, 'h', printField, printField != i14, z ? 2 : 0);
        int printField3 = printField(cArr, i6, 'm', printField2, printField2 != i14, z ? 2 : 0);
        int printField4 = printField(cArr, i5, 's', printField3, printField3 != i14, z ? 2 : 0);
        int printField5 = printField(cArr, i11, 'm', printField4, true, (!z || printField4 == i14) ? 0 : 3);
        cArr[printField5] = 's';
