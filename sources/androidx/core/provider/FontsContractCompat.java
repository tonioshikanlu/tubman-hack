...
public class FontsContractCompat {
    ...
    public static TypefaceResult getFontInternal(Context context, FontRequest fontRequest, int i2) {
        try {
            ...
            if (fetchFonts.getStatusCode() == 0) {
                Typeface createFromFontInfo = TypefaceCompat.createFromFontInfo(context, (CancellationSignal) null, fetchFonts.getFonts(), i2);
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(a.m("No package found for authority: ", providerAuthority));
            ...
            StringBuilder C = a.C("Found content provider ", providerAuthority, ", but package was not ");
            C.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(C.toString());
        }
    }
