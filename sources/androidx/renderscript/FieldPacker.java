...
public class FieldPacker {
    ...
    public void addObj(BaseObj baseObj) {
        ...
        if (baseObj != null) {
            if (RenderScript.sPointerSize == 8) {
                ...
                i2 = (int) baseObj.getID((RenderScript) null);
                addI32(i2);
                return;
            }
    ...
    public void align(int i2) {
        ...
        throw new RSIllegalArgumentException(a.g("argument must be a non-negative non-zero power of 2: ", i2));
    }
    ...
    public void reset(int i2) {
        if (i2 < 0 || i2 > this.mLen) {
            throw new RSIllegalArgumentException(a.g("out of range argument: ", i2));
        }
        this.mPos = i2;
    }
    ...
    public short subI16() {
        ...
        int i3 = i2 - 1;
        this.mPos = i3;
        return (short) (((short) (bArr[i3] & ExifInterface.MARKER)) | ((short) ((bArr[i2] & ExifInterface.MARKER) << 8)));
    }
    ...
    public int subI32() {
        ...
        int i5 = i4 - 1;
        this.mPos = i5;
        return (bArr[i5] & ExifInterface.MARKER) | ((bArr[i2] & ExifInterface.MARKER) << 24) | ((bArr[i3] & ExifInterface.MARKER) << 16) | ((bArr[i4] & ExifInterface.MARKER) << 8);
    }
    ...
    public long subI64() {
        ...
        int i9 = i8 - 1;
        this.mPos = i9;
        return (((long) bArr[i9]) & 255) | ((((long) bArr[i2]) & 255) << 56) | 0 | ((((long) bArr[i3]) & 255) << 48) | ((((long) bArr[i4]) & 255) << 40) | ((((long) bArr[i5]) & 255) << 32) | ((((long) bArr[i6]) & 255) << 24) | ((((long) bArr[i7]) & 255) << 16) | ((((long) bArr[i8]) & 255) << 8);
    }
