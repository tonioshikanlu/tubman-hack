...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                ...
                y.append(pathDataNodeArr[i2].mType);
                y.append(":");
                str = y.toString();
        ...
        public void printVPath(int i2) {
            ...
            StringBuilder B = a.B(str, "current path is :");
            B.append(this.mPathName);
            B.append(" pathData is ");
            B.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, B.toString());
        }
    ...
    public static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i2, int i3, ColorFilter colorFilter) {
            ...
            float f2 = ((float) i3) / this.mViewportHeight;
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public void updateCachedBitmap(int i2, int i3) {
            ...
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i2, i3, (ColorFilter) null);
        }
    }
    ...
    public static int applyAlpha(int i2, float f) {
        return (i2 & ViewCompat.MEASURED_SIZE_MASK) | (((int) (((float) Color.alpha(i2)) * f)) << 24);
    }
    ...
    private void printGroupTree(VGroup vGroup, int i2) {
        ...
        StringBuilder B = a.B(str, "current group is :");
        B.append(vGroup.getGroupName());
        B.append(" rotation is ");
        B.append(vGroup.mRotate);
        Log.v(LOGTAG, B.toString());
