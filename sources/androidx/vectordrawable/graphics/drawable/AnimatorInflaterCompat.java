...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        if (objArr != null && objArr.length != 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                StringBuilder z = a.z("Keyframe ", i2, ": fraction ");
                Object obj = "null";
                z.append(keyframe.getFraction() < 0.0f ? obj : Float.valueOf(keyframe.getFraction()));
                z.append(", , value : ");
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i2, int i3) {
        ...
        return ((!z2 || !isColorType(i4)) && (!z || !isColorType(z ? peekValue2.type : 0))) ? 0 : 3;
    }
